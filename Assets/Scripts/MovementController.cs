...
public abstract class MovementController : MonoBehaviour
{
    ...
    [SerializeField] public float fallGravity = 15;
    [SerializeField] public float lowJumpGravity = 20;
    [SerializeField] public float upGravity = 12;


    [HideInInspector] public event ModifyVelocity onVelocityModifier;
    [HideInInspector] private Vector3 groundCheckPos => transform.position + transform.up * (groundCheckYOffset - 0.5f * groundCheckSize.y) + transform.right * (groundCheckXOffset - 0.5f * groundCheckSize.x);
